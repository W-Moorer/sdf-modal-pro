...
def main() -> None:
    ...
    print(f"moving contact energy drift excess ratio: {result.summary['moving_contact_energy_drift_excess_ratio']:.6e}")
    print(f"small dynamic displacement RMSE: {result.summary['small_dynamic_displacement_rmse']:.6e}")
    print(f"small dynamic velocity RMSE: {result.summary['small_dynamic_velocity_rmse']:.6e}")
    ...
    print(f"small dynamic wall runtime ratio: {result.summary['small_dynamic_measured_wall_runtime_ratio']:.6e}")
    print(f"small dynamic solver-dimension speedup: {result.summary['small_dynamic_solver_dimension_speedup']:.6e}")
